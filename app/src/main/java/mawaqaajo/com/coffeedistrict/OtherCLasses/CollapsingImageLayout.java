...
public class CollapsingImageLayout extends FrameLayout {
    ...
    private int TimeLeftExpanded;
    private int TimeLeftCollapsed;
    ...
    private int TimeTopExpanded;
    private int TimeTopCollapsed;
    ...
    //    mImageLeftCollapsed = getResources().getDimensionPixelOffset(R.dimen.image_left_margin_collapsed);
        ...
        TimeLeftCollapsed= getResources().getDimensionPixelOffset(R.dimen.subtitle_left_margin_collapsed);
        mSubtitleTopCollapsed = getResources().getDimensionPixelOffset(R.dimen.subtitle_top_margin_collapsed);
        TimeTopCollapsed=getResources().getDimensionPixelOffset(R.dimen.subtitle_top_margin_collapsed);
...
//                }
                ...
                if (child.getId() == R.id.address_layout) {
                ...
                if (child.getId() == R.id.time_layout) {
                    int topOffset = (int) ((TimeTopCollapsed - TimeTopExpanded) * offsetFactor) - verticalOffset;
                    int leftOffset = (int) ((TimeLeftCollapsed - TimeLeftExpanded) * offsetFactor);
                    offsetHelper.setTopAndBottomOffset(topOffset);
                    offsetHelper.setLeftAndRightOffset(leftOffset);
                }

                if (child.getId() == R.id.site_layout) {
                    int topOffset = (int) ((mSubtitleTopCollapsed - mSubtitleTopExpanded) * offsetFactor) - verticalOffset;
                    int leftOffset = (int) ((mSubtitleLeftCollapsed - mSubtitleLeftExpanded) * offsetFactor);
                    offsetHelper.setTopAndBottomOffset(topOffset);
                    offsetHelper.setLeftAndRightOffset(leftOffset);
